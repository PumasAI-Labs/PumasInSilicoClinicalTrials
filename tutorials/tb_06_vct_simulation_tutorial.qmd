...
treatment_results = simobs(
    tumor_burden_model,
    [Subject(; id, covariates = (; treatment = true)) for id in selected_vps],
    param,
    vrandeffs[selected_vps];
    obstimes,
...
control_results = simobs(
    tumor_burden_model,
    [Subject(; id, covariates = (; treatment = false)) for id in selected_vps],
    param,
    vrandeffs[selected_vps];
    obstimes,
    simulate_error = false,
...
uncalibrated_treatment_results = simobs(
    tumor_burden_model,
    [Subject(; id, covariates = (; treatment = true)) for id in 1:length(vrandeffs)],
    param,
    vrandeffs;
    obstimes,
    simulate_error = false,
...
uncalibrated_control_results = simobs(
    tumor_burden_model,
    [Subject(; id, covariates = (; treatment = false)) for id in 1:length(vrandeffs)],
    param,
    vrandeffs;
    obstimes,
    simulate_error = false,
