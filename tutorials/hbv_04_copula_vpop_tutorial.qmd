...
The random effects η are Gaussian, but the 9 parameters are not (they are logit-/log-normal).
...
The observed p_S–k_A Spearman correlation is `{julia} round(spearman_param[1, 5], digits = 3)`,
close to the target `{julia} Rho[1, 5]` from @cortes2025HBV.
