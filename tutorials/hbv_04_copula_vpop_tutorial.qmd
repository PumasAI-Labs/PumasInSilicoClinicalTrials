...
The target **Spearman (rank) correlation** matrix of the parameters,
from the NLME estimates [@cortes2025HBV],
capturing the dependence structure among the 8 correlated parameters.
