...
```{julia}
#| fig-cap: "HBV Model: How measurement choice affects identifiability. Orange = locally identifiable (finite solutions), Red = non-identifiable (infinite solutions)."
...
```{julia}
#| fig-cap: "Adding measurements increases the percentage of locally identifiable parameters."
