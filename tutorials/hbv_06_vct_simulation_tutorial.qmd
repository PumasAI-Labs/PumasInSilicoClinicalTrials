...
correlated_randeffs_dist = SklarDist(
    copula, (
        Normal(0, ω_p_S),
        Normal(0, ω_β),
        Normal(0, ω_m), #truncated(Normal(0, ω_m); lower = -ω_m, upper = ω_m),
        Normal(0, ω_k_P), #truncated(Normal(0, ω_k_P); lower = -ω_k_P, upper = ω_k_P),
        Normal(0, ω_k_A), #truncated(Normal(0, ω_k_A); lower = -ω_k_A, upper = ω_k_A),
        Normal(0, ω_ϵ_NA), #truncated(Normal(0, ω_ϵ_NA); lower = -ω_ϵ_NA, upper = ω_ϵ_NA),
        Normal(0, ω_ϵ_IFN), #truncated(Normal(0, ω_ϵ_IFN); lower = -ω_ϵ_IFN, upper = ω_ϵ_IFN),
        Normal(0, ω_r_E_IFN), #truncated(Normal(0, ω_r_E_IFN); lower = -ω_r_E_IFN, upper = ω_r_E_IFN),
        Normal(0, ω_conv_E), #truncated(Normal(0, ω_conv_E); lower = -ω_conv_E, upper = ω_conv_E),
    )
)
```
