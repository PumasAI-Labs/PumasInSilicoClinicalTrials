...
We sample correlated random effects using the Gaussian copula with the correlation matrix from
@cortes2025HBV (see [HBV-04](hbv_04_copula_vpop_tutorial.qmd) for details):
