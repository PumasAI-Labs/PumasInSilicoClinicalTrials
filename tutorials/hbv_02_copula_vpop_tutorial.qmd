...
see [TB-02: Copula Vpop Generation](tb_02_copula_vpop_tutorial.qmd).
...
As explained in [TB-02](tb_02_copula_vpop_tutorial.qmd),
...
For a detailed explanation, see [TB-02](tb_02_copula_vpop_tutorial.qmd).
:::
...
```{julia}
#| fig-cap: "Corner plot showing all pairwise parameter relationships and marginal distributions. Spearman correlations are shown in the upper triangle."
pairplot(
    log10.(vpop[:, param_cols]) => (
        PairPlots.Scatter(),
...
In **[Tutorial 3: Global Sensitivity Analysis](hbv_03_gsa_tutorial.qmd)**, we will:

- Analyze which parameters most influence HBV treatment outcomes
- Use the generated virtual population for GSA parameter ranges
